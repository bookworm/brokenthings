...
static void save_clicked(GtkWindow *parent)
{
...
static void create_folder_clicked(GtkWindow *parent)
{
  GtkWidget *dialog, *chooser;
  gint result;
  gchar *filename;
...
static void open_clicked (GtkWindow *parent)
{
  GtkWidget *dialog, *chooser;
  gint result;
...
static void select_folder_clicked (GtkWindow *parent)
{
  GtkWidget *dialog, *chooser;
  gint result;
  gchar *filename;
